...
class SettingsController extends Controller
{
    ...
    public function apiPost(Request $request)
    {
        ...
        return isset($apiKey->id) ? back()->with(['message' => 'Successfully created new API Key', 'message_type' => 'success']) : back()->with(['message' => 'Error Creating API Key, please make sure you entered a valid name.', 'message_type' => 'danger']);
    }
