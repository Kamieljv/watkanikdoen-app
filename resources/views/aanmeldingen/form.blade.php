...
@section('content')
    ...
    <form role="form" method="POST" action="{{ route('aanmelding.create') }}">
        ...
        <div class="max-w-4xl mx-auto px-5 lg:px-0 flex justify-end">
            <button @if($viewOnly){{'disabled'}}@endif type="submit" class="flex justify-center px-4 py-2 text-sm font-medium text-white transition duration-150 ease-in-out border border-transparent rounded-md bg-blue-600 hover:bg-blue-500 disabled:bg-gray-400 focus:outline-none focus:border-blue-700 focus:shadow-outline-wave active:bg-blue-700">
