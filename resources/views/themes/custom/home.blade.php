...
@section('content')
    ...
    <div class="row">
        <div id="welcome" class="md:max-w-2xl px-3 md:px-0 my-5 m-auto text-center space-y-1 md:space-y-3 flex flex-col items-center justify-center">
            <h2 class="uppercase">Wat kan ik doen?</h2>
            @svg('custom-vormpje', ['style' => 'fill: var(--wkid-blue-light); height: 20px;'])
            <p>Welkom op de startpagina voor actief burgerschap.<br/>
