...
@section('content')
	...
	<div class="grid grid-cols-4 gap-3 px-8 mx-auto my-6 max-w-6xl xl:px-5">
		...
		<div class="w-full mr-6 col-span-4 md:col-span-1">
			...
			<div class="relative grid grid-cols-2 items-center justify-center w-full py-1 md:py-0 bg-white border shadow-md rounded-lg border-gray-150">
		...
		<div class="flex flex-col w-full bg-white border shadow-md rounded-lg col-span-4 md:col-span-3 border-gray-150">
