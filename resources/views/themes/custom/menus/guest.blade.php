<nav class="flex items-center justify-end flex-1 hidden w-full h-full space-x-10 lg:flex">
    ...
    <span class="inline-flex rounded-md shadow-sm" style="margin-left: 10px">
        <a href="#" class="inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap transition duration-150 ease-in-out border border-transparent rounded-md bg-blue-500 hover:bg-blue-600">
