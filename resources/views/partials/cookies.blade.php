...
<div class="fixed inset-x-0 bottom-0 z-[1002] flex items-end justify-center px-4 py-6 sm:p-6 sm:items-start sm:justify-start">
    <div id="cookie-consent" class="hidden w-full lg:w-2/5 min-w-[40rem] p-6 bg-white text-gray-800 rounded-xl shadow-[0_9px_25px_0_rgba(0,0,0,0.3)] border-gray-400">
        <h3 class="mb-5">We gebruiken cookies</h3>
        <p class="mb-2">
            We gebruiken uitsluitend cookies om web traffic te analyseren en delen geen data met derden.
        </p>
        <p>
