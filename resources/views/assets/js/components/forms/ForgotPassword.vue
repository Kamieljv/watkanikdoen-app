<template>
  <div class="flex flex-col justify-center py-20 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      <h2
        class="mt-6 text-3xl font-extrabold leading-9 text-center text-gray-900 lg:text-5xl"
      >
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      ...
      >
        <div
          ...
          v-sanitize.inline="responseMessage"
          class="p-3 text-sm rounded-md success"
        ></div>
        <div
          v-else-if="success == false"
          class="p-3 text-sm rounded-md failure"
        >
        ...
        <form v-if="success == null" action="#" method="POST">
          ...
          <div class="mt-6">
            <span class="block w-full rounded-md shadow-sm">
              <a
                class="flex justify-center w-full px-4 py-2 text-sm cursor-pointer font-medium text-white transition duration-150 ease-in-out border border-transparent rounded-md bg-blue-600 hover:bg-blue-500 focus:outline-none focus:border-blue-700 active:bg-blue-700"
                @click="submit"
              >
