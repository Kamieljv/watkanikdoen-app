          ...
          <div class="relative mx-auto max-w-7xl">
            <div v-if="!isGeladen && !appending">
              ...
              >
                <div class="flex space-x-3 w-full justify-start items-center">
                  ...
                  <div
                    class="relative h-6 w-1/3 inline-block bg-gray-200 rounded"
                  ></div>
                </div>
              </div>
            </div>
            <div v-else-if="heeftOrganizers">
              <Organizer
                ...
                @update:model-value="
                  updateOrganizersSelected($event, organizer)
                "
              >
                {{ organizer.selected }}
              </Organizer>
  ...
  axios
    ...
    .then((response) => {
      if (props.max) {
        ...
        organizers.value = organizers.value.concat(
          response.data.organizers.data,
        );
      } else {
