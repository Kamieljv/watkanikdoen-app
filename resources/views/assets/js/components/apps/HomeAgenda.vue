        ...
        <div class="relative mx-auto w-full">
          <div class="relative mx-auto max-w-7xl">
            <div v-if="!isGeladen">
              ...
              <div
                class="grid gap-5 mb-12 mx-auto mt-12 grid-cols-1 sm:grid-cols-2 md:grid-cols-3"
              >
                <div
                ...
                >
                  <div
                    class="flex-shrink-0 h-full col-span-1 bg-gray-200"
                  ></div>
                  <div
                    class="flex flex-col col-span-2 p-3 justify-between flex-1 bg-white"
                  >
            ...
            <div v-else-if="heeftActies">
              ...
              <div
                class="grid gap-5 mx-auto mt-12 grid-cols-1 sm:grid-cols-2 md:grid-cols-3"
              >
                <ActieSmall
              ...
              <div class="flex items-center justify-center my-12">
                <a href="/acties">
                  <button
                    ...
                    data-umami-event="View all actions button on homepage"
                  >
