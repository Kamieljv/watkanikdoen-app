    ...
    <div class="relative flex-item">
      ...
      <div class="flex" :class="{ 'h-full': fullHeight }">
        <Field
          ...
          :validate-on-mount="validateOn === 'mount'"
          :validate-on-input="validateOn === 'input'"
          :validate-on-change="validateOn === 'change'"
          :validate-on-blur="validateOn === 'blur'"
          :validate-on-model-update="validateOn === 'modelUpdate'"
          :class="classes"
...
const props = defineProps({
  ...
  validateOn: {
    ...
    default: "change",
    validator: (value: string) => {
      return ["mount", "input", "change", "blur", "modelUpdate"].includes(
        value,
      );
    },
  },
...
const value = defineModel<string | number | boolean | Array<string> | null>();
