  ...
  <div>
    ...
    >
      ...
      <template #button-right>
        <button
          class="primary plus-btn"
          :disabled="!url"
          title="Nog een link toevoegen"
          @click="addUrl"
        >
    ...
    <!-- Display added links -->
    <div class="mt-5">
      <div v-for="(u, index) in urls" :key="index"  class="flex items-center space-x-1">
        <a :href="u" class="text-blue-900 hover:underline" target="_blank">{{
          u
        }}</a>
