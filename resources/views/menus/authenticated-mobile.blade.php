        ...
        <div class="pt-6 pb-6 space-y-3">
            ...
            <div>
                <nav class="grid row-gap-8">
                    <a href="{{route('blog')}}" class="flex items-center px-8 py-3 space-x-3 transition duration-150 ease-in-out rounded-md hover:bg-gray-50">
