	...
	<div class="relative flex flex-col p-6">
		...
		<div class="w-full lg:w-9/12 xl:w-4/5">
			...
			<div class="flex justify-end w-full">
				<button class="flex self-end justify-center w-auto px-4 py-2 mt-5 text-sm font-medium text-white transition duration-150 ease-in-out border border-transparent rounded-md bg-blue-600 hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:shadow-outline-wave active:bg-blue-700" dusk="update-profile-button">{{ __("Save") }}</button>
			</div>
		</div>
	</div>
