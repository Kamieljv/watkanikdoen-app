...
@section('content')
    ...
    <div id="app" class="flex flex-col">
		...
		{{-- Who are we? --}}
		<div id="whoarewe-section" class="max-w-7xl w-full mx-auto my-10 h-[450px] md:h-[370px] text-white rounded-2xl relative overflow-hidden">
		...
		<div id="organizers-section" class="row py-20 px-3 text-gray-800">
			<div class="grid grid-cols-1 md:grid-cols-3 mx-auto my-10 max-w-6xl px-3 items-center md:divide-x">
        ...
        <!-- Statistics -->
		<div id="stats-section" class="row relative max-w-7xl w-full mx-auto my-10 rounded-2xl py-20 md:py-32 px-3 text-white overflow-hidden bg-[color:var(--wkid-blue)]">
		...
		{{-- Newsletter --}}
		<div id="newsletter-section" class="row relative w-full max-w-7xl mx-auto my-10 rounded-2xl py-20 md:py-32 px-3 text-gray-800 overflow-hidden bg-gray-200">
			<div class="flex flex-col mx-auto max-w-6xl px-3 items-center text-center">
