...
return [
    ...
    'externe_links' => 'Externe links',
    'start_date' => 'Begindatum',
    'start_time' => 'Begintijd',
    'end_date' => 'Einddatum',
    'end_time' => 'Eindtijd',
    'location' => 'Locatie',
    'location_on_map' => 'Locatie op de kaart',
    ...
    'reported_on' => 'Toegevoegd op',
    'status' => 'Status',
    'view' => 'Bekijk',
    'user_mismatch' => 'Er is iets misgegaan met het verifiëren van je identiteit. Probeer het opnieuw.',
    'pending_message' => 'Je actie is in behandeling. Je krijgt een e-mail zodra deze is goedgekeurd.',
    'rejected_message' => 'Je actie is afgewezen. Stuur ons een e-mail als je denkt dat dit een vergissing is.',
    'approved_message' => 'Je actie is goedgekeurd!',
